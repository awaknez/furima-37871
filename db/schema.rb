...
ActiveRecord::Schema.define(version: 2022_05_12_233320) do
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "name_family_name", null: false
    t.string "name_first_name_kana", null: false
    t.string "name_family_name_kana", null: false
